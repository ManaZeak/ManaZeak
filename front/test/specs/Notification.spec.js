...
describe('Notification unit test', () => {
  ...
  it('Private method _setOptionsDefault', done => {
    ...
    expect(options.duration).toEqual(4000);
  ...
  it('Private method _setAttributesDefault', done => {
    ...
    NotificationMgt._duration = -4000;
