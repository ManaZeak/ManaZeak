...
class Shortcut {
   ...
   * @author Arthur Beaulieu
   * @since September 2018
   * @description Test stored single key shortcuts regarding the keyboard event
   * @param {object} event - The Keyboard event from this._addEvents() */
   ...
   * @author Arthur Beaulieu
   * @since September 2018
   * @description Test stored multiple keys shortcuts regarding the keyboard event
   * @param {object} event - The Keyboard event from this._addEvents() */
  _multiKeyTest(event) {
  ...
  /** @method
   * @name _singleModifierTrigger
   * @private
   * @memberof Shortcut
   * @author Arthur Beaulieu
   * @since September 2018
   * @description Fires a shortcut with one modifier
   * @param {object} event - The Keyboard event from this._addEvents()
   * @param {object} shortcut - The shortcut to fire */
  ...
  /** @method
   * @name _doubleModifiersTrigger
   * @private
   * @memberof Shortcut
   * @author Arthur Beaulieu
   * @since September 2018
   * @description Fires a shortcut with two modifiers
   * @param {object} event - The Keyboard event from this._addEvents()
   * @param {object} shortcut - The shortcut to fire */
  ...
  /** @method
   * @name _tripleModifiersTrigger
   * @private
   * @memberof Shortcut
   * @author Arthur Beaulieu
   * @since September 2018
   * @description Fires a shortcut with three modifiers
   * @param {object} event - The Keyboard event from this._addEvents()
   * @param {object} shortcut - The shortcut to fire */
   ...
   * @param {string} keyString - The keys string (ie <code>Ctrl+Shift+A</code>)
