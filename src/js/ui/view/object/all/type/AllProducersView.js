...
class AllProducersView extends AllTagsView {
  ...
  _processAllArtists(response) {
    return new Promise(resolve => {
      this._dom.title.innerHTML = mzk.lang.allObjectsView.producers.title;
      this._dom.description.innerHTML = `${mzk.lang.allObjectsView.producers.description} ${response.PRODUCERS.length} ${mzk.lang.playlist.producers}.`;
