import VolumeBar from '../component/bar/VolumeBar.js';
import ProgressBar from '../component/bar/ProgressBar.js';
...
class FootBar {
  ...
  _init() {
    ...
    this._playbackRateContext = new PlaybackRateContext({
      ...
      url: 'context/PlaybackRateContext/'
    });

    this._queueContext = new QueueContext({
      target: document.body,
      url: 'context/queuecontext/'
    });
  }
