...
DROP SEQUENCE SEQ_PLAYLIST_ASIDE;
...
ALTER TABLE playlist_aside DROP CONSTRAINT FK_playlist_aside_playlist;
ALTER TABLE playlist_aside DROP CONSTRAINT FK_playlist_aside_user;
...
DROP INDEX IDX_playlist_aside_playlist;
DROP INDEX IDX_playlist_aside_user;
