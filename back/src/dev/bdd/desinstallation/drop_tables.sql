...
ALTER TABLE artist DROP CONSTRAINT FK_artist_bio;
ALTER TABLE band_artist DROP CONSTRAINT FK_band_artist_1;
ALTER TABLE band_artist DROP CONSTRAINT FK_band_artist_2;
ALTER TABLE band DROP CONSTRAINT FK_band_label;
ALTER TABLE band DROP CONSTRAINT FK_band_link;
ALTER TABLE band DROP CONSTRAINT FK_band_country;
ALTER TABLE band DROP CONSTRAINT FK_band_bio;
...
ALTER TABLE track_recording_location DROP CONSTRAINT FK_track_recording_location_1;
ALTER TABLE track_recording_location DROP CONSTRAINT FK_track_recording_location_2;
...
DROP INDEX IDX_track_recording_location_1;
DROP INDEX IDX_track_recording_location_2;
