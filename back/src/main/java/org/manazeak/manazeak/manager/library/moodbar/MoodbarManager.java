...
public class MoodbarManager {
    ...
    public MoodbarGenerationReport launchMoodbarGeneration(MoodbarGenerationProjection trackInfo) throws IOException {
        ...
        for (MoodbarSizeEnum size : MoodbarSizeEnum.values()) {
            ...
            try {
                ...
                if (response.statusCode() != 200 && !report.isError()) {
     ...
     */
    private Path createMoodbarImageDestination(String moodMd5, MoodbarSizeEnum size) throws IOException {
    ...
    private Path getMoodbarDestination(String moodMd5, String sizeFolder) throws IOException {
