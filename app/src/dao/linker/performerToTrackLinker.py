...
class PerformerToTrackLinker(AbstractDao):

    ## Create the links between tracks and performer.
    def linkArtistToTracks(self, tracksLinkedToComposers):
        loggerScan.info(str(len(tracksLinkedToComposers)) + ' performers to link.')
    ...
    def _generateRequest(self, links):
        return 'INSERT INTO app_track_performers (track_id, artist_id) VALUES {} '\
